(function (window, undefined) {
    ...
    function Input(manager, callback) {
        ...
        this.evEl &&
            addEventListeners(this.manager.element, this.evEl, this.domHandler);
    ...
    Input.prototype = {
        ...
        destroy: function () {
            ...
            this.winEvents &&
                removeEventListeners(window, this.winEvents, this.domHandler);
        },
    };
    ...
    var POINTER_WINDOW_EVENTS =
        "pointermove pointerout pointerup pointercancel";

    // IE10 has prefixed support, and case-sensitive
    if (window.MSPointerEvent) {
        POINTER_ELEMENT_EVENTS = "MSPointerDown";
        POINTER_WINDOW_EVENTS =
            "MSPointerMove MSPointerOut MSPointerUp MSPointerCancel";
    }
    ...
    inherit(PointerEventInput, Input, {
        ...
        handler: function (ev) {
            ...
            if (
                ...
                (ev.button === 0 || pointerType == INPUT_TYPE_TOUCH)
            ) {
                store.push(ev);
    ...
    Manager.prototype = {
        ...
        recognize: function (inputData) {
            ...
            for (var i = 0, len = this.recognizers.length; i < len; i++) {
                ...
                if (
                    this.session.stopped !== FORCED_STOP && // 1
                    (!curRecognizer ||
    ...
    function toggleCssProps(manager, add) {
        ...
        if (cssProps.userSelect == "none") {
            element.onselectstart = falseFn;
        }
        if (cssProps.userDrag == "none") {
